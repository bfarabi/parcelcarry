  ...
  return (
    <>
      ...
      <div className="row bg-dark">
        <div className="col-md-6">
            <p className='text-white fw-bold pt-5 text-center'>আমাদের অনলাইন ট্র্যাকিং সার্ভিস দিয়ে কুরিয়ার ট্র্যাক করুন</p>
        </div>
    ...
    <div className="row App py-5">
        <div className="col-md-3">
            <img class="" src="https://redx.com.bd/images/c2c/safety-first.svg" alt="" />
